...
from main.views import add_product_ajax, get_product_json, show_main, show_xml, show_json, show_xml_by_id, show_json_by_id, register, login_user, logout_user, delete_item, add_item, subtract_item, get_total_stock
